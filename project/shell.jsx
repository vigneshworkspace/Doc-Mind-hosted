...
// --- icons (inline strokes, matched weight) ---
function Icon({ name, size = 18, className = "nav-icon" }) {
    ...
    <aside className="side">
      ...
      <div className="side-masthead">
        <div className="side-mast-row">
          <img className="side-mast-fox" src="assets/fox-head.png" alt="DocMind" />
          <div>
...
// --- top bar ---
function TopBar({ tab, dark, onToggleDark, onOpenSearch, onOpenMenu, pomodoro, setPomodoro, setTab, user, onLogout }) {
...
// --- Claude-style theme toggle: sliding pill with sun/moon ---
...
// --- floating pomodoro mini ---
function PomodoroMini({ pomodoro, setPomodoro, onOpen }) {
...
window.PomodoroMini = PomodoroMini;

// --- command palette ---
function CommandPalette({ open, setOpen, setTab, documents = [] }) {
